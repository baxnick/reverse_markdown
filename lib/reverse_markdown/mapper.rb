module ReverseMarkdown
  class Mapper
    ...
    def substitute_em(element, parent)
      ...
      if element.text.strip.empty? or (element.ancestors('em') + element.ancestors('i')).empty?
        ''
      else
    ...
    def substitute_b(element, parent)
      ...
      if element.text.strip.empty? or (element.ancestors('strong') + element.ancestors('b')).empty?
        ''
      else
